    ...
    <div class="container position-relative">
        ...
        <div class="row">
            ...
            while (have_rows('faq')) {
                the_row();
                ?>
        <div itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question" class="py-4 border-bottom">
            ...
            <div class="answer collapse <?=$show?>" itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" id="collapse_<?=$counter?>" class="accordion-collapse collapse show" aria-labelledby="heading_<?=$counter?>" data-bs-parent="#accordion">
                <div itemprop="text" class="pt-2"><?=apply_filters('the_content',get_sub_field('answer'))?></div>
            </div>
        </div>
                <?php
                $counter++;
