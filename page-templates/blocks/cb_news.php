<div class="container-xl pb-5">
	<div class="row mb-4">
		<div class="col-12 flex-wrap d-flex flex-stretch">
			<button class="btn btn--tab news_selector active" data-bs-slide-to="0" data-bs-target="#newsCarousel">All</button>
			<button class="btn btn--tab news_selector" data-bs-slide-to="1" data-bs-target="#newsCarousel">Expatriate Advice</button>
			...
			<button class="btn btn--tab news_selector" data-bs-slide-to="4" data-bs-target="#newsCarousel">Expat Health &amp; Safety</button>
    	</div>
	</div>
