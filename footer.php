...
<footer class="wrapper pb-0 pt-5" id="wrapper-footer">
	<div class="container-xl">
		...
		<div class="row g-3">
			<div class="col-md-3">
				<div class="row gy-3">
					<div class="col-sm-4 col-xl-12">
						...
						<div class="font-lightblue"><?= wp_kses_post( get_field( 'contact_address_uk', 'options' ) ); ?></div>
					</div>
					<div class="col-sm-4 col-xl-12">
						<div class="text-white fw-bold mb-1">EU Office</div>
						<div class="font-lightblue"><?= wp_kses_post( get_field( 'contact_address', 'options' ) ); ?></div>
					</div>
					<div class="col-sm-4 col-xl-12">
						<div class="text-white fw-bold mb-1">Asia Office</div>
						<div class="font-lightblue"><?= wp_kses_post( get_field( 'contact_address_asia', 'options' ) ); ?></div>
					</div>
					<div class="col-sm-4 col-xl-12">
						<div class="text-white fw-bold mb-1">Registered Address</div>
						<div class="font-lightblue"><?= wp_kses_post( get_field( 'registered_address', 'options' ) ); ?></div>
					</div>
					<div class="col-12">
						...
						<div class="font-lightblue">Tel: <?= esc_html( get_field( 'malaysia_phone', 'options' ) ); ?> (MY)</div>
						<div class="font-lightblue">Fax: <?= esc_html( get_field( 'contact_fax', 'options' ) ); ?></div>
						<div class="font-lightblue">Email: <?= do_shortcode( '[contact_email]' ); ?></div>
					</div>
					<div class="col-12">
						<div class="text-white fw-bold mb-1">Office Times</div>
						<div class="font-lightblue"><?= wp_kses_post( get_field( 'office_times', 'options' ) ); ?></div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="col mb-4">
					<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/Expatriate_WHITE.svg' ); ?>" class="img-fluid footer-img" alt="expatriate group">
				</div>
				<div class="col mb-3">
			...
			<div class="col-md-12 text-white fs-8 mb-4 mb-md-0">
				Expatriate Group & Expatriate Healthcare are trading styles of Strategic Insurance Services Limited<br><br>Non-European Union resident policies are sold by Strategic Insurance Services Limited (SISL). SISL is authorised and regulated by the Financial Conduct Authority (FCA) in the United Kingdom. FCA Firm Reference Number is 307133. SISL is authorised to carry on Regulated Activities in accordance with the permissions granted by the FCA under PART IV of the Financial Services and Markets ACT 2000. Address: Delmon House, 36-38 Church Road, Burgess Hill RH15 9AE, United Kingdom.<br><br>European Union resident policies are sold by Strategic Insurance Brokers (Cyprus) Ltd (SIBC). Company Number: HE394431. SIBC is authorised and regulated by the Cypriot Insurance Superintendent, per Authorization Number: 7255. Address: Androkleous 19a, 1061 Nicosia, Cyprus.<br><br><?= do_shortcode( '[srg_logo]' ); ?>Strategic Insurance Services Limited is part of the Specialist Risk Group (SRG), one of the fastest-growing groups of insurance intermediaries in the UK, placing £1.6 BN of premium into the Global insurance market. SRG brings together individuals and businesses from across the world with a plethora of UK and international broking and underwriting specialisms, serving more than 120,000 clients.<br><br>For more information about how we use and disclose your personal information, your rights under data protection law and who you can contact, please refer to our <a href="https://specialistrisk.com/privacy-policy/" target="_blank" class="text-decoration-underline text-white">privacy notice</a>.<br><br>
					<div class="d-flex justify-content-between flex-wrap gap-4">
						...
						<a href="https://secure.ethicspoint.eu/domain/media/en/gui/115636/index.html" target="_blank" class="text-decoration-underline text-white">Whistleblowing Facility</a>
        ...
        <div class="colophon site-footer border-top border-2 py-4">
            <div class="text-center text-white fs-8"><?= esc_html( gmdate( 'Y' ) ); ?> Expatriate Group. All Rights Reserved. <a href="https://www.chillibyte.co.uk/" rel="nofollow noopener" target="_blank" class="cb position-relative ms-2" style="top: 3px;" title="Digital Marketing by Chillibyte"></a></div>
        </div>
    </div>
</footer>
        		...
        		<div class="row justify-content-center gy-2 g-md-4">
					<div class="col-md-6">
						<div class="card p-4">
							...
							<div class="d-none d-md-block"><?= esc_html( get_field( 'health_modal', 'options' ) ); ?></div>
							<a class="btn btn-health" target="_blank" href="<?= esc_url( get_field( 'health_quote', 'options' ) ); ?>">Get Quote</a>
					...
					<div class="col-md-6">
						<div class="card p-4 h-100">
							...
							<div class="d-none d-md-block"><?= esc_html( get_field( 'travel_modal', 'options' ) ); ?></div>
							<a class="btn btn-travel" target="_blank" href="<?= esc_url( get_field( 'travel_quote', 'options' ) ); ?>">Get Quote</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Life Insurance</div>
							<div class="d-none d-md-block"><?= esc_html( get_field( 'life_modal', 'options' ) ); ?></div>
							<a class="btn btn-life" target="_blank" href="<?= esc_url( get_field( 'life_quote', 'options' ) ); ?>">Get Quote</a>
						</div>
					</div>
				</div>
      		</div>
      		...
      		<div class="modal-body">
				<div class="row gy-2 g-md-4">
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">International Health Insurance</div>
							<a class="btn btn-health" href="<?= esc_url( get_field( 'health_renewal', 'options' ) ); ?>">Renew</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Travel Insurance</div>
							<a class="btn btn-travel" href="<?= esc_url( get_field( 'travel_renewal', 'options' ) ); ?>">Renew</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Life Insurance</div>
							<a class="btn btn-life" href="<?= esc_url( get_field( 'life_renewal', 'options' ) ); ?>">Renew</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Income Protection Insurance</div>
							<a class="btn btn-income" href="<?= esc_url( get_field( 'income_renewal', 'options' ) ); ?>">Renew</a>
						</div>
					</div>
				</div>
      		</div>
			...
			<div class="modal-body">
				<div class="row gy-2 g-md-4">
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">International Health Insurance</div>
							<a class="btn btn-health" href="<?= esc_url( get_field( 'health_retrieve', 'options' ) ); ?>">Retrieve Quote</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Travel Insurance</div>
							<a class="btn btn-travel" href="<?= esc_url( get_field( 'travel_retrieve', 'options' ) ); ?>">Retrieve Quote</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Life Insurance</div>
							<a class="btn btn-life" href="<?= esc_url( get_field( 'life_retrieve', 'options' ) ); ?>">Retrieve Quote</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card p-4">
							<div class="fw-bold fs-5 text-black mb-2">Income Protection Insurance</div>
							<a class="btn btn-income" href="<?= esc_url( get_field( 'income_retrieve', 'options' ) ); ?>">Retrieve Quote</a>
						</div>
					</div>
				</div>
			</div>
...
<div class="sticky-buttons" id="stickyButton">
    <a class="btn btn-<?= esc_attr( $product ); ?>" href="<?= esc_url( $url ); ?>">Get a Quote</a>
</div>
	<?php
}
?>
